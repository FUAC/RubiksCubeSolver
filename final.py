...
while(1):
	...
	ret,frame = cap.read()
	cv2.circle(frame,(400,400), 30, (0,0,255), 2)
	cv2.circle(frame,(500,400),30,(0,0,255),2)
	cv2.circle(frame,(600,400), 30, (0,0,255), 2)
	cv2.circle(frame,(400,600), 30, (0,0,255), 2)
	cv2.circle(frame,(500,500), 30, (0,0,255), 2)
	cv2.circle(frame,(500,600), 30, (0,0,255), 2)
	cv2.circle(frame,(600,400), 30, (0,0,255), 2)
	cv2.circle(frame,(600,500), 30, (0,0,255), 2)
	cv2.circle(frame,(600,600), 30, (0,0,255), 2)
	cv2.circle(frame,(400,500), 30, (0,0,255), 2)
